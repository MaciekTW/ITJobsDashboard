...
def update_dashboard(start_date, end_date):
    ...
    'Total Job Offers Over Time', 'C++ Job Offers Over Time', 'Rust Job Offers Over Time'))
    ...
    dashboard.update_layout(height=900, width=1000, showlegend=True, legend=dict(
        orientation="h",
        yanchor="bottom",
        y=1.03,
        xanchor="center",
